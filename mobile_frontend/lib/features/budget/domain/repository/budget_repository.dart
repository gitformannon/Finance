...
abstract class BudgetRepository {
  ...
  Future<Either<Failure, void>> updateAccount(UpdateAccountRequest request);
  Future<Either<Failure, void>> updateCategory(UpdateCategoryRequest request);
  Future<Either<Failure, void>> updateTransaction(UpdateTransactionRequest request);
}
